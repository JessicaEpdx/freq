...
describe('String#freq') do
  ...
  it("returns the number of times that a given words appears in a given string of words, even if words in string are capitals or attached to punctuation") do
